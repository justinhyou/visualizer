...
document.addEventListener('DOMContentLoaded', function() {
	...
	range.oninput = function(){
		renderStatus('How well does this job fit you?');
	...
	r2d2.onclick = function(){
      ...
      renderStatus('We think this fits you 88%!');
			// if(xhttp.readyState == 4 && xhttp.status == 200) {
			// 	console.log(xhttp.responseText);
			// 	renderStatus('We think this fits you: ' +  xhttp.responseText + '%!');
			// }else{
			// 	renderStatus('Error!');
			// }
		}
	...
	rate.onclick = function(){
		...
		xhttp.send(params);
		renderStatus('Thanks! Goto/hierarchy for details!');
